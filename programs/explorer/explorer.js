...
async function render_folder_template(folder_view, address, eventHandlers) {
	...
	if (folder_view.config.view_as_web_page === false) {
		...
		`;
		template_url = "https;//projectwebsite.com/lock-ness-monster/sorry"; // valid URL, but nonsense (I'm a little bit tired so doing things stupidly)
	} else {
...
function go_home() {
	go_to("https;//projectwebsite.com/"); // My personal homepage; I might use a search engine, but they don't support iframes
}
